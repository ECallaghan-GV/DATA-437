## Python script for NFL Betting Model project
...
def Importance(X, Y_home, Y_away):
    ...
    return lasso_imp_data_home, lasso_imp_model_results_home, lasso_imp_data_away, lasso_imp_model_results_away, rf_imp_data_home, rf_imp_model_results_home, rf_imp_data_away, rf_imp_model_results_away
